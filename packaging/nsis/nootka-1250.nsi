...
!define PRODUCT_VERSION "0.8.4-rc1"
...
LangString NelDesc ${LANG_CZECH} "Úroveò zkouky programu Nootka"
...
LangString NooDesc ${LANG_CZECH} "Zkuební soubor programu Nootka"
...
;FunctionEnd
   ...
   LangString UninstallMess ${LANG_POLISH} "Czy rzeczwicie chcesz usun¹æ Nutkê i jej sk³adniki?"
   LangString UninstallMess ${LANG_CZECH} "Opravdu chcete odstranit Nootku a vechny její souèásti?"
