...
!insertmacro MUI_UNGETLANGUAGE
   ...
   LangString UninstallMess ${LANG_POLISH} "Czy rzeczwiście chcesz usunąć Nutkę i jej składniki?"
   LangString UninstallMess ${LANG_CZECH} "Opravdu chcete odstranit Nootku a všechny její součásti?"
