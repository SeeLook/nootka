...
//    supp += "<li><b>English in Nootka is clumsy. If eglish is your native, please take a look <a href=\"http://nootka.googlecode.com/hg/lang/nootka_xx.ts\">on this file</a>, where are all texts and verify it. See next paragraph if you have questions or write me.</a></b></li><br>";
		supp += "<li><b>Samples of bass guitar sound</b><br>So far bass output goes through MIDI. If you can record them contact to me, please.<br></li>";
		supp += "<li><b>Pitture of bass or electric guitar is needed</b><br>Picture size about 2000 pixels and with guitar body WITHOUT THE STRINGS. Nootka likes to be pretty.<br></li>";
