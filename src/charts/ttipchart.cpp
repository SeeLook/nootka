    ...
    , m_point(point)
{
    ...
    case TQAtype::e_asName:
        qS = "<span style=\"font-size: xx-large;\">" + point->question()->qa.note.toRichText(point->question()->styleOfQuestion()) + "</span>";
        if (point->question()->answerAs == TQAtype::e_asName)
            aS = "<span style=\"font-size: xx-large;\">" + point->question()->qa_2.note.toRichText(point->question()->styleOfAnswer()) + "</span>";
        break;
    ...
    if (aS == "") {
        ...
        case TQAtype::e_onScore:
            ...
            break;
        case TQAtype::e_asName:
            aS = "<span style=\"font-size: xx-large;\">" + point->question()->qa.note.toRichText(point->question()->styleOfAnswer()) + "</span>";
            break;
        case TQAtype::e_onInstr:
    ...
    txt += "<table valign=\"middle\" align=\"center\"><tr><td> " + qS + " </td><td>" + TnooFont::span("?", 45, "color: red") + " </td><td> " + aS
        + " </td></tr></table>";
