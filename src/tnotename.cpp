...
// ACCID BUTTONS TOOOLBAR
    ...
    dblFlatButt->setFont(QFont("Emmentaler", 16, QFont::Normal));
...
//     dblFlatButt->setIcon(QIcon(gl->path+"picts/dblflat.svg"));
    ...
    flatButt->setFont(QFont("Emmentaler", 16, QFont::Normal));
...
//     flatButt->setIcon(QIcon(gl->path+"picts/flat.svg"));
    ...
    sharpButt->setFont(QFont("Emmentaler", 16, QFont::Normal));
...
//     sharpButt->setIcon(QIcon(gl->path+"picts/sharp.svg"));
    ...
    dblSharpButt->setFont(QFont("Emmentaler", 16, QFont::Normal));
