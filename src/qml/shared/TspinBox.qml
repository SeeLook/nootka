...
SpinBox {
    ...
    editable: true
    height: sb.font.pixelSize * 2.5
    width: sb.font.pixelSize * 10
    ...
    background: Rectangle {
        ...
        width: sb.width - sb.height
        height: sb.height - sb.font.pixelSize / 4
        x: sb.height / 2
        y: sb.font.pixelSize / 8

        border {
            width: sb.activeFocus ? 1 : 0
