...
Column {
    function save() {
        if (enableInChB.checked) {
            ...
            GLOB.minDuration = minDurSpin.value / 1000;
            GLOB.minVolume = volSpin.value / 100;
    ...
    function help() {
        NOO.openDocLink("2017/05/17/audio-settings/");
    }
                ...
                Column {
                    ...
                    Tile {
                        ...
                        Row {
                            ...
                            TlabelText {
                                text: qsTr("minimum note duration")
                            }
                    ...
                    Tframe {
                        ...
                        Column {
                            ...
                            Switch {
                                ...
                                indicator: Rectangle {
                                    implicitWidth: NOO.factor() * 4
                                    implicitHeight: NOO.factor()
                                    x: advSwitch.leftPadding
                            ...
                            Tile {
                                ...
                                Row {
                                    ...
                                    TlabelText {
                                        text: qsTr("pitch detection mode")
                                    }
