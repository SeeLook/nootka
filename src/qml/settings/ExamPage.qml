...
Tflickable {
    ...
    function help() {
        NOO.openDocLink("2017/05/17/exercises-exams-settings/");
    }
    ...
    Column {
            ...
            Column {
                ...
                Tile {
                    ...
                    Row {
                        ...
                        Text {
                            text: NOO.TR("StartExam", "student name:")
                            color: activPal.text
                ...
                Grid {
                    ...
                    columns: wrongColor.parent.width + correctColor.parent.width + notBadColor.parent.width + NOO.factor() * 4 < parent.width ? 3 : (wrongColor.parent.width + correctColor.parent.width + spacing < parent.width ? 2 : 1)
                    horizontalItemAlignment: Grid.AlignHCenter
                    ...
                    Row {
                        ...
                        TlabelText {
                            text: qsTr("color of 'not bad' answers")
                        }

                        ColorButton {
                            id: notBadColor

                            color: GLOB.notBadColor
                            title: qsTr("color of 'not bad' answers")
                        }
        ...
        Tframe {
            ...
            Column {
                ...
                Text {
                    text: NOO.TR("TexamHelp", "Exercises")
                    color: activPal.text
                    font.bold: true
                }
    ...
    TpopupDialog {
        ...
        Tflickable {
            ...
            contentHeight: expText.height + NOO.factor() * 2
