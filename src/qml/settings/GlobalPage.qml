...
Tflickable {
    ...
    function help() {
        NOO.openDocLink("2017/05/17/settings/");
    }
    ...
    Column {
        ...
        Tile {
            ...
            Tumbler {
                ...
                Rectangle {
                    z: -1
                    width: langTumb.height * 1.1
                    height: langTumb.height * 0.7
                    x: langTumb.width / 2 - width / 2
                    y: langTumb.height * 0.01
    ...
    // workaround to select 0 item, call it with delay
    Timer {
        id: langTimer
