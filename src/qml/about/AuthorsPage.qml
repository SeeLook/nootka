...
Tflickable {
    ...
    Column {
        ...
        Tile {
            ...
            Column {
                ...
                TextBackground {
                    text: qsTranslate("TaboutNootka", "Code")
                }
        ...
        Tile {
            ...
            Column {
                ...
                TextBackground {
                    text: qsTranslate("TaboutNootka", "Audio")
                }
        ...
        Tile {
            ...
            Column {
                ...
                TextBackground {
                    text: qsTranslate("TaboutNootka", "Translators")
                }
                ...
                ListModel {
                    ...
                    ListElement {
                        ...
                        lang: "Český"
                        trr: "Pavel Fric"
                        web: "<a href=\"http://fripohled.blogspot.com\">fripohled.blogspot.com</a>"
                    }

                    ListElement {
                        flag: "de"
                        lang: "Deutsch"
                        trr: "Renato Reinau,<br>Johann C. Weihe"
                        web: ""
                    }
                    ...
                    ListElement {
                        ...
                        lang: "Español"
                        trr: "José Luis Marín"
                        web: "<a href=\"mailto:jsls@gmx.com\">jsls@gmx.com</a>"
                    }

                    ListElement {
                        flag: "fr"
                        lang: "Français"
                        trr: "Jean-Marc Lartigue,<br>Olivier Devineau"
                        web: ""
                    }
                    ...
                    ListElement {
                        ...
                        lang: "Magyar"
                        trr: "Gábor Kertész"
                        web: "<a href=\"mailto:kergab@gmail.com\">kergab@gmail.com</a>"
                    }

                    ListElement {
                        flag: "it"
                        lang: "Italiano"
                        trr: "Gianluca 'Kununna' Fiorentino,<br>Alessandro Mandelli"
                        web: ""
                    }
                    ...
                    ListElement {
                        ...
                        lang: "polski"
                        trr: "Tomasz Bojczuk"
                        web: "<a href=\"mailto:seelook.gmail.com\">seelook@gmail.com</a>"
                    }

                    ListElement {
                        flag: "br"
                        lang: "português\nbrasileiro"
                        trr: "Lucas Marques Fonseca"
                        web: "<a href=\"https://github.com/LucasMarquess\">GitHub</a>"
                    }

                    ListElement {
                        flag: "ru"
                        lang: "Русский"
                        trr: "Timur Artykov,<br>Sergei Ivanov (tico-tico)"
                        web: ""
                    }
        ...
        Tile {
            ...
            Column {
                ...
                TextBackground {
                    text: qsTranslate("TaboutNootka", "Other projects")
                }
                ...
                ListView {
                    ...
                    anchors.horizontalCenter: parent.horizontalCenter
                    width: aboutCont.width - NOO.factor() * 6
                    ...
                    model: [
                        ...
                        createLink("RtAudio", "https://www.music.mcgill.ca/~gary/rtaudio/index.html") + " by G. P. Scavone",
        ...
        Tile {
            ...
            Column {
                ...
                TextBackground {
                    text: qsTranslate("TaboutNootka", "Thanks")
                }
                ...
                ListView {
                    anchors.horizontalCenter: parent.horizontalCenter
                    width: aboutCont.width - NOO.factor() * 4
                    height: contentHeight
                    spacing: NOO.factor() / (NOO.isAndroid() ? 4 : 2)
                    model: [
    ...
    Timer {
        ...
        interval: 35
        repeat: true
        running: GLOB.useAnimations && authorsPage.visible
        onTriggered: {
