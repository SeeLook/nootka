...
SequentialAnimation {
    ...
    SequentialAnimation {
        ...
        NumberAnimation {
            target: wItem
            property: "y"
            to: wItem ? wItem.y + shakeStep / 2 : 0
            duration: 50
        }
    ...
    ParallelAnimation {
        ...
        NumberAnimation {
            ...
            property: "scale"
            from: 0.1
            to: GLOB.instrument.type === 5 ? 1.2 : 1
            duration: 200
        }
    ...
    SequentialAnimation {
        NumberAnimation {
            ...
            property: "scale"
            from: 1
            to: GLOB.instrument.type === 5 ? 2.5 : 2
            duration: 200
        }
