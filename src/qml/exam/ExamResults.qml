...
Grid {
    ...
    Row {
        spacing: NOO.factor()
        width: resultsItem.width / 2
        leftPadding: (width - childrenRect.width) / 2
        ...
        ProgressBar {
            ...
            height: nootkaWindow.width / 70
            from: 0
            to: results.progressMax
            ...
            // can not be null to handle mouse click/tap
    ...
    Component {
        ...
        Popup {
            ...
            Column {
                ...
                Repeater {
                    model: [results.resultsTxt(), results.answersHint(), results.progressHint(), results.summaryHint(), results.correctHint(), results.halfHint(), results.wrongHint(), results.effectHint(), results.averageHint()]
