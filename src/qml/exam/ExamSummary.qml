...
TexamSummary {
    ...
    Column {
        ...
        Tflickable {
            width: parent.width
            height: summDialog.height - buttGrid.height - NOO.factor()
            clip: true
            contentWidth: width
            contentHeight: resGrid.height
                    ...
                    Tile {
                        ...
                        Grid {
                            ...
                            Column {
                                ...
                                Text {
                                    anchors.horizontalCenter: parent.horizontalCenter
                                    text: qsTranslate("TexamSummary", "Kinds of mistakes") + ":"
                                    color: activPal.text
                                }
        ...
        Grid {
            ...
            TiconButton {
                ...
                pixmap: NOO.pix(isExercise() ? "practice" : "exam")
                iconHeight: buttGrid.buttHeight
