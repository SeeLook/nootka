...
ApplicationWindow {
    ...
    Row {
        ...
        Item {
            ...
            height: nootkaWindow.height - footer.height
            width: height * 0.246
        ...
        Item {
            ...
            width: parent.width - (NOO.isAndroid() ? 0 : parent.height * 0.246)
            ...
            SwipeView {
                ...
                Loader {
                    ...
                    onActiveChanged: {
                        if (active)
                            setSource("qrc:/about/HelpPage.qml", {
                                "enableTOC": false,
                                "height": parent.height,
    ...
    // HACK: load clef page to set params properly when user will skip wizard but with delay to keep launch quick
    Timer {
        running: true
        interval: 500
    ...
    footer: Rectangle {
        ...
        Row {
            ...
            PageIndicator {
                ...
                delegate: Rectangle {
                    implicitWidth: nextBut.height / 2
        ...
        TcuteButton {
            ...
            Shortcut {
                sequence: "Return"
                onActivated: nootkaWindow.close()
            }
