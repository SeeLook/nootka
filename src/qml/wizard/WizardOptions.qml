...
Tflickable {
    ...
    contentWidth: width
    contentHeight: optCol.height + NOO.factor() * 2
    ...
    Column {
        ...
        Select7note {
            ...
            style: lettersRadio.checked ? (is7B ? Nootka.English_Bb : Nootka.Norsk_Hb)
                                        : (Qt.locale().name.indexOf("ru") === -1 ? Nootka.Italiano_Si : Nootka.Russian_Ci)
