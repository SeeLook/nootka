...
Tflickable {
    ...
    contentWidth: width
    contentHeight: modeCol.height + NOO.factor() * 2
    ...
    Column {
        ...
        LinkText {
            ...
            text: qsTr("In main Nootka window score can be displayed in a few different ways, depends on experience level.").replace(", ", ",<br>")
        ...
        Tile {
            ...
            bgBorder {
                width: 2
                color: singleRadio.checked ? nootkaWindow.labelColor : activPal.text
            }
            ...
            Column {
                ...
                GlowRect {
                    ...
                    radius: NOO.factor() / 2
                    width: singleRow.width + NOO.factor()
                    height: singleRow.height + NOO.factor()
                    ...
                    Row {
                        ...
                        Rectangle {
                            color: activPal.base
                            width: singleScore.width
                            height: singleScore.height * 0.5

                            Score {
                                id: singleScore

                                height: Math.max(NOO.factor() * 15, nootkaWindow.height * 0.3)
                                width: Math.max(NOO.factor() * 10, nootkaWindow.height * 0.16)
                        ...
                        Column {
                            ...
                            Rectangle {
                                color: activPal.base
                                width: wizardMode.width * 0.3
                                height: singleScore.height * 0.2
        ...
        Tile {
            ...
            bgBorder {
                width: 2
                color: simpleRadio.checked ? nootkaWindow.labelColor : activPal.text
            }
            ...
            Column {
                ...
                LinkText {
                    width: wizardMode.width - NOO.factor() * 3
                    wrapMode: Text.WordWrap
                    horizontalAlignment: Text.AlignHCenter
                    anchors.horizontalCenter: parent.horizontalCenter
