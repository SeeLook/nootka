...
TnameItem {
    ...
    Rectangle {
        ...
        Text {
            ...
            style: Text.Outline
            styleColor: markColor
            transformOrigin: Item.Center
            scale: 3 // scale to increase outline for marking answers

            font {
                pixelSize: Math.min(parent.height * 0.266, width * 0.05)
                family: "Scorek"
            }
    ...
    Row {
        ...
        RectButton {
            ...
            statusTip: octavesLinkStatus()
            statusPos: Item.Top

            font {
                pixelSize: buttHeight * 0.4
                bold: true
            }
        ...
        Repeater {
            ...
            TcuteButton {
                ...
                font {
                    pixelSize: height * (GLOB.scientificOctaves ? 0.8 : 0.5)
                    bold: true
                }
