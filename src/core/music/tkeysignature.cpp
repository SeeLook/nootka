...
QString TkeySignature::majorNames[15] = {QString(),
                                         QString(),
                                         QString(),
                                         QString(),
                                         QString(),
                                         ...
                                         QString(),
                                         QString()};
QString TkeySignature::minorNames[15] = {QString(),
                                         QString(),
                                         QString(),
                                         QString(),
                                         QString(),
...
void TkeySignature::setNameStyle(Tnote::EnameStyle style, const QString &majSuf, const QString &minSuf)
{
    ...
    if (majSuf.isEmpty()) {
        ...
        GLOB->scoreParams->majKeyNameSufix = majorSufixTxt();
    } else if (majSuf != QLatin1String(" "))
        majS = minus + majSuf;

    if (minSuf.isEmpty()) {
        minS = minus + minorSufixTxt();
        GLOB->scoreParams->minKeyNameSufix = minorSufixTxt();
    } else if (minSuf != QLatin1String(" "))
        minS = minus + minSuf;
