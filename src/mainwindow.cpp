...
//     examResults->setGeometry(centralWidget()->width()- score->width() -2,
//             centralWidget()->height() - guitar->height() - qRound(centralWidget()->height() * 0.4) - examResults->height(),
//               examResults->width(), examResults->height()  );
