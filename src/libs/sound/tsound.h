...
public:
  ...
  TabstractSniffer*   sniffer() { return m_sniffer; }
  ...
  Q_INVOKABLE QStringList midiOutPorts() const;
  Q_INVOKABLE QStringList midiInPorts() const;
...
private:
  ...
  TabstractSniffer       *m_sniffer = nullptr;
  TaudioIN               *m_audioSniffer = nullptr;
