...
public:
     ...
     */
    Ttune(const QString &tuneName = QString(),
          const Tnote &S1 = Tnote(),
          const Tnote &S2 = Tnote(),
          const Tnote &S3 = Tnote(),
          const Tnote &S4 = Tnote(),
          const Tnote &S5 = Tnote(),
          const Tnote &S6 = Tnote(),
          Etunings tunType = NoTuning);
    ...
    {
        return (stringsArray[0] == T2[1] && stringsArray[1] == T2[2] && stringsArray[2] == T2[3] && stringsArray[3] == T2[4] && stringsArray[4] == T2[5]
                && stringsArray[5] == T2[6]);
    }
    bool operator!=(Ttune &T2) const
    {
