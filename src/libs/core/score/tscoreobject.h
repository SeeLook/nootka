...
{
public:
    TclefOffset(qint8 noteOff = 0, qint8 octaveOff = 0)
        : note(noteOff)
        , octave(octaveOff)
    {
    }
    ...
    void set(qint8 nOff, qint8 oOff)
    {
        note = nOff;
        octave = oOff;
    }
...
public:
    ...
    Q_INVOKABLE void saveMusicXml(const QString &musicFile, const QString &title = QString(), const QString &composer = QString(), int transposition = 0);
