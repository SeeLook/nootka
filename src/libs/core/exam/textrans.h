 ...
 * It keeps contexts of previous location of the texts 
 * for compatibility with already existing translations
 */
...
static const QString halfMistakenAddTxt() { return QApplication::translate("TexamView", "(counted as half of a mistake)"); }
