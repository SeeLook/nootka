/**
 * Fake header with texts to translate not ocurr in code but in mime types and desktop
 */

QApplication::translate("File association entries", "to play scores");
QApplication::translate("File association entries", "Application for learning musical score notation");
