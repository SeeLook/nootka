...
#if defined (Q_OS_ANDROID)
  helpTxt += QLatin1String("This feature has been not ready yet in Android version.<br><b>You may transfer Nootka files to desktop computer and see results in Nootka version there.");
#else
