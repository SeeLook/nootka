...
TpaneItem::TpaneItem(int charNr, QGraphicsObject* parent) :
...
//###################              PROTECTED           ############################################
//#################################################################################################
void TpaneItem::mousePressEvent(QGraphicsSceneMouseEvent* event) {
  setGraphicsEffect(0);
  emit clicked();
...
void TpaneItem::hoverEnterEvent(QGraphicsSceneHoverEvent* event) {
...
void TpaneItem::hoverLeaveEvent(QGraphicsSceneHoverEvent* event) {
  setGraphicsEffect(0);
  emit leaved(this);
